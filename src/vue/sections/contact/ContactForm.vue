    ...
    <div class="row contact-form-row align-items-stretch">
      ...
      <div class="col-xl-6">
        ...
        <div class="form-group input-group">
          ...
          <input class="form-control" id="form-email" type="email" :placeholder="data.getString('email') + ' *'"
                 required/>
        </div>
        ...
        <div class="form-group input-group">
          ...
          <input class="form-control" id="form-subject" type="text" :placeholder="data.getString('subject') + ' *'"
                 required/>
        </div>
      </div>
