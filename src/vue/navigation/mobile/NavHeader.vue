<template>
  <div class="nav-header">
    ...
    <div v-if="categorySections.length >= 2" class="nav-pills-fixed-container nav-pills-fixed-container-shrink"
         id="nav-pills-fixed-container">
      <!-- Title -->
      <h4 v-if="fixedContainerTitle" class="nav-pills-page-title text-white">{{ fixedContainerTitle }}</h4>

      <!-- Pills -->
      <NavPills class="nav-pills-fixed" id="nav-pills-fixed" :sections="categorySections"
